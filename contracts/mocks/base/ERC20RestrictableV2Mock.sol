...
import { ERC20RestrictableV2 } from "../../base/ERC20Restrictable.sol";

/**
 * @title ERC20RestrictableMock contract
 * @author CloudWalk Inc.
 * @notice An implementation of the {ERC20RestrictableV2} contract for testing purposes
 */
contract ERC20RestrictableMockV2 is ERC20RestrictableV2 {
    /**
    ...
    function initialize(string memory name_, string memory symbol_) public initializer {
        __ERC20RestrictableV2_init(name_, symbol_);
    }
