 ...
 * @dev Safely replaces the obsolete part of the basic smart contract `ERC20Mintable`.
 *
 * This contract is used through inheritance. It has the same storage as the smart contract part it replaces,
...
abstract contract LegacyMintablePlaceholder {
    ...
    /// @dev The address of the main minter.
    ...
    /**
     * @dev Emitted when the main minter is changed.
    ...
    /**
     * @dev The transaction sender is not a main minter.
