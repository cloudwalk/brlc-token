 ...
 * @dev Safely replaces the storage of the obsolete basic smart contract `ERC20Trustable`.
 *
...
abstract contract LegacyTrustablePlaceholder {
    ...
    /// @dev The mapping of the configured `trusted` status of the accounts.
    ...
    /**
     * @dev Emitted when the `trusted` status of the account is configured.
    ...
    /// @dev Thrown when the account is already configured with the same `trusted` status.
