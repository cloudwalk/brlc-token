...
describe("Contract 'BlacklistableUpgradeable'", async () => {
    ...
    const EVENT_NAME_TEST_NOT_BLACKLISTED_MODIFIER_SUCCEEDED =
        "TestNotBlacklistedModifierSucceeded";
    ...
    before(async () => {
        ...
        blacklistableFactory = await ethers.getContractFactory(
            "BlacklistableUpgradeableMock"
        );
    });
    ...
    describe("Function 'initialize()'", async () => {
        it("Configures the contract as expected", async () => {
            ...
            expect(await blacklistable.blacklister()).to.equal(
        ...
        it("Is reverted if the implementation contract is called even for the first time", async () => {
            const blacklistableImplementation: Contract =
                await blacklistableFactory.deploy();
